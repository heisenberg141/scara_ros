...
class find_end_velRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type find_end_velRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type find_end_velRequest
    let len;
    let data = new find_end_velRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new find_end_velRequest(null);
...
class find_end_velResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type find_end_velResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type find_end_velResponse
    let len;
    let data = new find_end_velResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new find_end_velResponse(null);
    if (msg.vx !== undefined) {
      resolved.vx = msg.vx;
    }
    else {
...
module.exports = {
  Request: find_end_velRequest,
  Response: find_end_velResponse,
  md5sum() { return '9503a353c3cb5de32c444326819cd306'; },
  datatype() { return 'scara_robot_control/find_end_vel'; }
};
